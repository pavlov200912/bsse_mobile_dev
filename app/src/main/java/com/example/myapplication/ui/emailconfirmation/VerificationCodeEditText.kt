...
import com.example.myapplication.databinding.ViewVerificationCodeEditBinding
...
class VerificationCodeEditText @JvmOverloads constructor(
    ...
    private val viewBinding =
        ViewVerificationCodeEditBinding.inflate(LayoutInflater.from(context), this)
    ...
    // TODO: handle non-constant number of slots
